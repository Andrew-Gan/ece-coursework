...
typedef struct PCB {
  ...
  double estcpu;
  uint32 numquantum;
  unsigned int flag_autowake;
  unsigned int flag_yielding;
} PCB;
...
#define TIME_PER_CPU_WINDOW             10 //jiffies  /*This is also known as a quantum*/
#define CPU_WINDOWS_BETWEEN_DECAYS      10            /*This is also known as a quanta */
